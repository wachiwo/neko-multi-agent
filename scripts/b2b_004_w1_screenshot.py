#!/usr/bin/env python3
"""subtask_184_b2b_004_w1 self-verify screenshot.

004_国別累計得意先上位分析表.html の B2b 本格改修後、
...
TARGET = Path(
    "/mnt/i/仕事/001_ディムコ/001_ソース/001_モック/dimco-prototype/new/004_国別累計得意先上位分析表.html"
)
OUTDIR = Path(
    "/mnt/c/tools/neko-multi-agent/outputs/dimco-prototype/"
    "cmd_184_b2b/phase1_w1"
)
ZOOMS = [1.0, 1.5, 2.0]
