#!/usr/bin/env python3
"""subtask_184_b2c_phase2_verify_w4: 3viewport screenshots for 008/009/010."""
...
OUTDIR = Path("/mnt/c/tools/neko-multi-agent/outputs/dimco-prototype/cmd_184_b2c/phase2_w4_verify")
TARGETS = [
    ("008", BASE / "008_売上実績表.html"),
    ("009", BASE / "009_売上粗利表.html"),
    ("010", BASE / "010_売上予測表.html"),
]
ZOOMS = [1.0, 1.5, 2.0]
