#!/usr/bin/env python3
"""subtask_184_b2d_011_w1 self-verify screenshot."""
...
TARGET = Path(
    "/mnt/i/仕事/001_ディムコ/001_ソース/001_モック/dimco-prototype/new/011_累計仕入先上位分析表.html"
)
OUTDIR = Path(
    "/mnt/c/tools/neko-multi-agent/outputs/dimco-prototype/cmd_184_b2d/phase1_w1"
)
ZOOMS = [1.0, 1.5, 2.0]
            ...
            probe = page.evaluate(
                """() => {
                    ...
                    return {
                        ...
                        form_row_grid_template: rows[0] ? getComputedStyle(rows[0]).gridTemplateColumns : null,
                        total_form_fields: fields.length,
