#!/usr/bin/env python3
"""subtask_184_b2e_044_w3 self-verify screenshot (cmd_184 FINAL batch).

044_支払一覧.html の B2e Phase 1 改修後、zoom 100/150/200% で
canonical (form-field + form-field-inline + CollapsibleSection) + sp_041 + sp_042 を確認。
"""
...
TARGET = Path(
    "/mnt/i/仕事/001_ディムコ/001_ソース/001_モック/dimco-prototype/new/044_支払一覧.html"
)
OUTDIR = Path(
    "/mnt/c/tools/neko-multi-agent/outputs/dimco-prototype/cmd_184_b2e/phase1_w3"
)
ZOOMS = [1.0, 1.5, 2.0]
