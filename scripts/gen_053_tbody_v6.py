#!/usr/bin/env python3
"""Generate tbody v6:
- Level 1 ▷ button goes in col 1 (same 28px col as parent ▷) → no width mismatch
- Level 1 header/data: col1=empty or ▷, col2=empty, then data...
- Level 2 header/data: col1=empty, col2=empty, col3=empty, then data...
"""
...
for i, r in enumerate(rows):
    ...
    # Parent row: 13 cols
    # [▷(col1)][操作(col2)][書類種別(col3)]...[PACKING(col13)]
    lines.append(
    ...
    # Level 1 header: ▷ col(col1)=empty, col2=empty, data fills rest = 13
    lines.append(
    ...
    # Level 1 data: col1 = ▷ btn (same 28px col as parent), col2 = empty, data fills rest = 13
    lines.append(
    ...
    # Level 2 header: col1=empty, col2=empty, col3=empty, data fills rest = 13
    lines.append(
    ...
    # Level 2 data: col1=empty, col2=empty, col3=empty, data fills rest = 13
    lines.append(
