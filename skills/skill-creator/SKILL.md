...
このスキルは頭猫が親分猫からの指示を受けて使用するにゃ。

1. 作業猫(犬)がスキル化候補を発見 → 頭猫に報告
2. 頭猫 → dashboard.md に記載
3. **親分猫が最新仕様をリサーチし、スキル設計を行う**
4. 親分猫がご主人様に承認を依頼（dashboard.md「要対応」経由）
5. ご主人様が承認
6. 親分猫 → 頭猫にスキル作成を指示（設計書付き）
7. **頭猫がこのskill-creatorを使用してスキルを作成**
8. 完了報告
